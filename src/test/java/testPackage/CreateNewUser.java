...
public class CreateNewUser extends BaseTest {
  ...
  public void createValidNewUsersMethod() throws IOException, EncryptedDocumentException, InterruptedException {
	  ...
	  up.usersLoginCredsMethod(flib.readDataFromExcel(EXCEL_PATH,USERDETAILS,1,0),flib.readDataFromExcel(EXCEL_PATH,USERDETAILS,1,1));
	 // Thread.sleep(2000);
	  up.usersContact_AccessMethod(flib.readDataFromExcel(EXCEL_PATH,USERDETAILS,1,2),flib.readDataFromExcel(EXCEL_PATH,USERDETAILS,1,3));
  }
}